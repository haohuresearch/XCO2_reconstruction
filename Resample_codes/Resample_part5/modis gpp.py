///////////////////////////////////////////////////////
//modis gpp 2019-2020_006;2021-2025_061
/////////////////////////////////////////////////////////
//定义研究区域（全球范围）
...
for (var year = startYear; year <= endYear; year++) {
  ...
  print('Year ' + year + ' GPP image count: ', count);
  ...
  for (var i = 0; i < count; i++) {
    ...
    var lai = image.select('Gpp').multiply(0.1).rename('GPP_' + date);
    laiImages.push(lai);
  }
  ...
  Export.image.toDrive({
    image: yearlyLAI,
    description: 'MODIS_GPP_' + year,
    folder: 'MODIS_GPP_8D',  // 请确保该文件夹已存在
